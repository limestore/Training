        ...
        if(Trigger.isInsert)
        {
            ...
            for (Project_Milestone__c pm : Trigger.new) 
            {
                if (pm.RMS_Owned_Flag__c != null && pm.RMS_Owned_Flag__c == true)
                {
                    ...
                    {
                        System.debug('Cast Iron Integration User has provided a new Milestone Definition Id value of: ' + pm.Milestone_Definition__c);
                        System.debug('Cast Iron Integration User has provided a new Location Name value of: ' + pm.Location_Name__c);
        ...
        else if(Trigger.isUpdate)
        {
            ...
            for(Project_Milestone__c pm: Trigger.newMap.values())
            {
                if (Trigger.oldMap.containsKey(pm.id)) 
                {
                    ...
                    System.debug('The old Milestone Definition Id value we: ' + pmOld.Milestone_Definition__c);
                    System.debug('The old Location Name value was: ' + pmOld.Location_Name__c);
                    System.debug('Cast Iron Integration User has provided an updated Milestone Definition Id value of: ' + pm.Milestone_Definition__c);
                    System.debug('Cast Iron Integration User has provided an updated Location Name value of: ' + pm.Location_Name__c);
