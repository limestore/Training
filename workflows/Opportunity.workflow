...
a.  it’s status is set to “Closed-Won” and “N/S Document Attached” is set to “true”.</description>
    ...
    <rules>
        ...
        <formula>AND( RecordTypeId = &quot;01240000000ICUP&quot;, 
ISPICKVAL(Internal_Lead_Source__c, &quot;Digital Ad Spend Specialist&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>((Digital_Advertising_QC__c == null || Digital_Advertising_QC__c &lt;&gt; RSF_Digital_Advertising_QC__c) &amp;&amp; NOT (ISBLANK(RSF_Digital_Advertising_QC__c )) &amp;&amp; RSF_Digital_Advertising_QC__c &gt;= 0)
 &amp;&amp; ( $RecordType.Id = &quot;01240000000ICUP&quot; || $RecordType.Id = &quot;01240000000ICUO&quot; || $RecordType.Id = &quot;01240000000ICUN&quot;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>(Digital_Marketing_QC__c == null || Digital_Marketing_QC__c &lt;&gt; (RSF_Digital_Marketing_QC__c + RSF_Digital_Advertising_QC__c)) &amp;&amp; 
 (NOT (ISBLANK(RSF_Digital_Marketing_QC__c )) &amp;&amp; RSF_Digital_Marketing_QC__c &gt;= 0 || NOT (ISBLANK(RSF_Digital_Advertising_QC__c )) &amp;&amp; RSF_Digital_Advertising_QC__c &gt;= 0) 
 &amp;&amp; ( $RecordType.Id = &quot;01240000000ICUP&quot; || $RecordType.Id = &quot;01240000000ICUO&quot; || $RecordType.Id = &quot;01240000000ICUN&quot;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
