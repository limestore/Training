...
&quot;Other&quot;)</formula>
    ...
    <rules>
     ...
     SEO_Opt_Out__c =FALSE,
     PRIORVALUE(SEO_Opt_Out__c)=TRUE)</formula>
    ...
    <rules>
        ...
        <formula>And(
PRIORVALUE( PowerSEO_Product__c) &gt; 0,
PowerSEO_Product__c = 0)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
OR( ISCHANGED( DMS__c ) , 
ISCHANGED( DMS_Secondary__c ) , 
ISCHANGED( Password__c ) , 
