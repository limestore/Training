...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <ccEmails>SJanzen@robynpromo.com.training</ccEmails>
...
Promotion_Project__r.Name = &quot;Fight for First&quot; 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
Open_Status__c=&quot;Closed&quot;
    ...
    <rules>
        ...
        <formula>AND(
         NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
    OR(
         NOT(INCLUDES( Product_Type__c , &quot;GM Power Reputation Management&quot;)),
        NOT(INCLUDES(Product_Type__c, &quot;Power Reputation Management&quot;))
       ),
        $RecordType.Name = &quot;SM/RM Launch&quot;,
         ISPICKVAL(Order_Type__c ,&quot;Downgrade&quot;),
          Open_Status__c =&quot;Closed&quot;
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
...
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
Promotion_Project__r.Name &lt;&gt; &quot;Fight for First&quot;,
NOT(ISPICKVAL(Status__c,&quot;Not Started&quot;)),
NOT(ISPICKVAL(Status__c,&quot;Not Enrolled&quot;)),
$RecordType.Name &lt;&gt; &quot;Website Launch&quot;,
$RecordType.Name &lt;&gt; &quot;AMA Launch&quot;
)</formula>
    ...
    <rules>
        ...
        <formula>AND($RecordType.Name &lt;&gt; &quot;AMA Launch&quot;, 
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
...
Promotion_Project__r.Name &lt;&gt; &quot;Fight for First&quot; 
   ...
   Open_Status__c = &quot;Closed&quot;,  
   OR(
      INCLUDES( Product_Type__c , &quot;Power SEO&quot;), 
      INCLUDES( Add_Ons__c , &quot;Power SEO&quot;)
     ),
   Promotion_Project__r.Name &lt;&gt; &quot;Fight for First&quot;
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
   ...
   NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)),   
   Open_Status__c = &quot;Closed&quot;,  
   PowerSEO_Product__c =1,
   OR(
      $RecordType.Name = &quot;Search Products Launch&quot;,
      $RecordType.Name = &quot;DAP Launch&quot;,
      $RecordType.Name = &quot;SM/RM Launch&quot;
       )
 )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
...
$RecordType.Name = &quot;Website Launch&quot;, 
(ISPICKVAL(Status__c,&quot;In Progress&quot;)), 
NOT( Promotion_Project__r.Name = &quot;Fight for First&quot;) 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
(
$RecordType.Name = &quot;Website Launch&quot; || 
$RecordType.Name = &quot;A La Carte Launch&quot;
)&amp;&amp; 
NOT(ISBLANK( Account_Advocate__c))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>CB_SvcOps_EML_Launch_Ready_for_Onboarding</fullName>
        <actions>
            <name>Alert_Ops_Launch_Ready_for_Onboarding</name>
            <type>Alert</type>
        </actions>
        ...
        <active>true</active>
        <description>Only EM, SMRM and PSEO: Send alert to Service Ops to create onboarding case. Except for SM product type of GM Network RepMan.</description>
        <formula>(Open_Status__c = &quot;Closed&quot; &amp;&amp; 
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
Do_Not_Send_Onboarding__c = FALSE &amp;&amp; 
ISBLANK(Order_Closed_Waiting_on_Data_Date__c)) &amp;&amp; 
$RecordType.Name &lt;&gt; &quot;Website Launch&quot; &amp;&amp; 
$RecordType.Name &lt;&gt; &quot;DAP Launch&quot; &amp;&amp; 
$RecordType.Name &lt;&gt; &quot;Search Products Launch&quot; &amp;&amp; 
$RecordType.Name &lt;&gt; &quot;A La Carte Launch&quot;&amp;&amp; 
$RecordType.Name &lt;&gt; &quot;AMA Launch&quot;&amp;&amp; 
Send_Onboarding__c =FALSE 
|| 
($RecordType.Name = &quot;SM/RM Launch&quot; &amp;&amp; 
((ISPICKVAL(Status__c, &quot;Order Closed Waiting on Data&quot;) || 
ISPICKVAL(Status__c, &quot;Oracle Order Closed&quot;)) &amp;&amp; 
ISBLANK(Order_Closed_Waiting_on_Data_Date__c ))&amp;&amp; 
Do_Not_Send_Onboarding__c = FALSE &amp;&amp; 
Send_Onboarding__c =FALSE 
) 
|| 
($RecordType.Name = &quot;Email Marketing Launch&quot; &amp;&amp; 
(ISPICKVAL(Status__c, &quot;Oracle Order Closed&quot;) &amp;&amp; 
ISBLANK(Order_Closed_Waiting_on_Data_Date__c))&amp;&amp; 
Send_Onboarding__c =FALSE 
) 
|| 
($RecordType.Name = &quot;PowerSEO Launch&quot; &amp;&amp; 
Open_Status__c = &quot;Closed&quot;&amp;&amp; 
Send_Onboarding__c =FALSE 
) 
|| 
...
Open_Status__c = &quot;Closed&quot;&amp;&amp; 
( 
INCLUDES(Product_Type__c,&quot;Dealer Group Support&quot;)|| 
INCLUDES(Product_Type__c,&quot;Group Account Management&quot;) 
)&amp;&amp; 
Send_Onboarding__c =FALSE 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        <fullName>CB_SvcOps_HoldenSRCH_Launch_Ready_for_ONB</fullName>
        <actions>
        ...
        <active>true</active>
        <description>Search Products Launch w/ Holden Product: Sends a notification to Service Ops to create an Onboarding case.</description>
        <formula>NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
$RecordType.Name = &quot;Search Products Launch&quot; &amp;&amp;  
Open_Status__c = &quot;Closed&quot;&amp;&amp;
INCLUDES(Product_Type__c, &quot;Holden NV Advertising&quot;)&amp;&amp;
Send_Onboarding__c  = FALSE</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
(($RecordType.Name = &quot;Website Launch&quot; &amp;&amp; 
(INCLUDES( Add_Ons__c , &quot;ProCare&quot;)|| 
INCLUDES( Add_Ons__c , &quot;Audience Optimization&quot;)) &amp;&amp; 
( NOT(ISBLANK(Oracle_Order_Number__c))|| 
Open_Status__c = &quot;Closed&quot;)&amp;&amp; 
ISBLANK( Account_Advocate__c)&amp;&amp; 
Sent_AA_Assign_Alert__c = FALSE &amp;&amp; 
Send_Onboarding__c = FALSE) 
|| 
($RecordType.Name = &quot;A La Carte Launch&quot; &amp;&amp; 
(INCLUDES( Product_Type__c , &quot;ProCare&quot;)|| 
INCLUDES( Product_Type__c , &quot;Audience Optimization&quot;)) &amp;&amp; 
( NOT(ISBLANK(Oracle_Order_Number__c))|| 
Open_Status__c = &quot;Closed&quot; )&amp;&amp; 
ISBLANK( Account_Advocate__c)&amp;&amp; 
Sent_AA_Assign_Alert__c = FALSE &amp;&amp; 
...
Send_Onboarding__c = FALSE ))</formula>
    ...
    <rules>
        ...
        <formula>AND(Open_Status__c = &quot;Closed&quot;,
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
Send_SEO_Onboarding__c=FALSE,
OR(
   AND(
       $RecordType.Name = &quot;Website Launch&quot; &amp;&amp; 
       OR(
          INCLUDES(Add_Ons__c, &quot;Power SEO&quot;),
          INCLUDES(Add_Ons__c,&quot;SEO Essentials&quot;),
          INCLUDES(Product_Type__c , &quot;Audience Management Package&quot;),
          INCLUDES(Product_Type__c,&quot;VW Core&quot;)
          )
      ),
   AND(
      $RecordType.Name = &quot;A La Carte Launch&quot; &amp;&amp; 
       OR(
          INCLUDES( Product_Type__c , &quot;Power SEO&quot;),
          INCLUDES(Product_Type__c ,&quot;SEO Essentials&quot;)
          )
      )
)
)</formula>
...
(
   (
      INCLUDES(Product_Type__c, &quot;Performance&quot;) &amp;&amp; 
      (
       ISPICKVAL( Order_Type__c, &quot;New&quot;)||
       ISPICKVAL(Order_Type__c,&quot;Upgrade&quot;)||
       ISPICKVAL(Order_Type__c,&quot;Multi-Brand&quot;)
       )
    )|| 
(
   (INCLUDES(Product_Type__c,&quot;Core/ProSite&quot;)||
    INCLUDES(Product_Type__c,&quot;Base&quot;)
    )&amp;&amp;
   OEM__c=&quot;GM&quot;&amp;&amp;
   NOT(INCLUDES(Product_Type__c, &quot;Performance&quot;))&amp;&amp;
   ISPICKVAL(Order_Type__c,&quot;Downgrade&quot;)
 )
)
&amp;&amp;
...
CONTAINS(WebID__r.Name, &quot;holdennz&quot;), 
INCLUDES(Add_Ons__c , &quot;ProCare&quot;), 
$RecordType.Name = &quot;Website Launch&quot; 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <formula>AND(
        NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
        Promotion_Project__r.Name = &quot;Holden&quot;,
        NOT(ISBLANK( Published_Site_in_WSM__c ))
        )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND( NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), NOT($User.Id = OwnerId ), 
NOT($User.Id = Secondary_Owner__c ), 
ISPICKVAL( Order_Priority__c , &quot;911&quot;), 
LEFT( OwnerId ,3)&lt;&gt;&apos;00G&apos; 
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>($RecordType.Name = &quot;PowerSEO Launch&quot; &amp;&amp; 
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp; 
Open_Status__c = &quot;Closed&quot; &amp;&amp; 
INCLUDES(Product_Type__c, &quot;Power SEO&quot;)&amp;&amp; 
(ISPICKVAL(Order_Type__c,&quot;New&quot;)|| 
ISPICKVAL(Order_Type__c,&quot;Upgrade&quot;)) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>And( 
Not(ISblank( Welcome_Kit_Requested__c)), 
$RecordType.Name = &quot;Email Marketing Launch&quot;, 
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
Not( Contains(&quot;Sandbox&quot;,Account__r.Name))
)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>And ( $RecordType.Name = &quot;SM/RM Launch&quot;, 
OR(
         ...
         Includes( Product_Type__c , &quot;GM Primary Plus Reputation Management&quot;),
         Includes(Product_Type__c, &quot;Essentials Reputation Management&quot;),
         Includes(Product_Type__c, &quot;Advanced Reputation Management&quot;),
         Includes(Product_Type__c, &quot;Power Reputation Management&quot;)
       ),
Open_Status__c = &quot;Closed&quot;, Isblank(Welcome_Kit_Requested__c ), 
Not( Contains(&quot;Sandbox&quot;,Account__r.Name)) ,
