...
NOT(CONTAINS(TEXT(Status__c), &quot;Cancel&quot;)) &amp;&amp; 
...
CONTAINS (Assigned_External_Dev__r.Profile.Name, &quot;System Administrator&quot;)) )</formula>
    ...
    <rules>
        ...
        <description>Updates record type to SalesForce Project when request status is set to Closed - Won</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
 ...
 Includes_Field_Data_Type_Changes__c = True</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Request__c.Status__c</field>
            <operation>notEqual</operation>
            <value>Cancelled,Approved - Pending Reqts,Waiting on Approval,Working,Pending Reqts,Closed</value>
        </criteriaItems>
        <criteriaItems>
            <field>User.Username</field>
            <operation>notContain</operation>
        ...
        <criteriaItems>
            <field>Request__c.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>Custom Dev Project</value>
        </criteriaItems>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Request__c.Status__c</field>
            <operation>notEqual</operation>
            <value>Cancelled,Working,Closed</value>
        </criteriaItems>
        <criteriaItems>
            <field>User.Username</field>
            <operation>notContain</operation>
