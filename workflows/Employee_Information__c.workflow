...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <ccEmails>sales_automation@adp.com.training</ccEmails>
...
&quot;&quot;)</formula>
    ...
    <rules>
        ...
        <formula>AND(User__r.IsActive = FALSE, User__r.Inactive_Due_to_Inactivity__c = FALSE, 
OR(ISPICKVAL(Status_Del__c, &quot;Active&quot;), ISPICKVAL(Status_Del__c, &quot;&quot;)), ISPICKVAL(License_Status_Del__c, &quot;In Use&quot;), 
ISPICKVAL(License_Status_Del__c, &quot;&quot;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
