...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Alert_to_Key_Rep_Changes_for_New_Party_to_DS_SalesOps</fullName>
        <ccEmails>ds.Salesops@adp.com.training</ccEmails>
        <description>Alert to Key Rep Changes for New Party to DS_SalesOps NO LONGER USED</description>
        <protected>false</protected>
        <recipients>
            <recipient>dave.hanson@cdk.com</recipient>
            <type>user</type>
    ...
    <rules>
        ...
        <formula>AND ( ISCHANGED( Key_Rep__c ), Out_of_Business__c &lt;&gt; TRUE, Duplicate__c &lt;&gt; TRUE, NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), CASE(Region__c, &quot;Hoffman Sales&quot;, &quot;Hoffman Sales&quot;, &quot;ARG&quot;, &quot;ARG&quot;, &quot;CANADA&quot;, &quot;CANADA&quot;, &quot;CENTRAL NORTH&quot;, &quot;CENTRAL NORTH&quot;, &quot;CENTRAL SOUTH&quot;, &quot;CENTRAL SOUTH&quot;, &quot;WEST&quot;, &quot;WEST&quot;, &quot;SOUTH&quot;, &quot;SOUTH&quot;,&quot;NORTH&quot;, &quot;NORTH&quot;, &quot;TRUCK&quot;, &quot;TRUCK&quot;, &quot;NATIONAL&quot;, &quot;NATIONAL&quot;,&quot;ENTERPRISE&quot;, &quot;ENTERPRISE&quot;, &quot;PFW&quot;, &quot;PFW&quot;, &quot;Independent Truck Dealers&quot;, &quot;Independent Truck Dealers&quot;, &quot; &quot;) &lt;&gt; CASE(Key_Rep__r.Region__c, &quot;Hoffman Sales&quot;, &quot;Hoffman Sales&quot;, &quot;ARG&quot;, &quot;ARG&quot;, &quot;CANADA&quot;, &quot;CANADA&quot;, &quot;CENTRAL NORTH&quot;, &quot;CENTRAL NORTH&quot;, &quot;CENTRAL SOUTH&quot;, &quot;CENTRAL SOUTH&quot;, &quot;WEST&quot;, &quot;WEST&quot;, &quot;SOUTH&quot;, &quot;SOUTH&quot;,&quot;NORTH&quot;, &quot;NORTH&quot;, &quot;TRUCK&quot;, &quot;TRUCK&quot;, &quot;NATIONAL&quot;, &quot;NATIONAL&quot;,&quot;ENTERPRISE&quot;, &quot;ENTERPRISE&quot;, &quot;PFW&quot;, &quot;PFW&quot;, &quot;Independent Truck Dealers&quot;, &quot;Independent Truck Dealers&quot;, &quot; &quot;), CASE(Key_Rep__r.Segment_Code__c, &quot;MULTIPLE&quot;, &quot;MULTIPLE&quot;, &quot; &quot;) &lt;&gt; &quot;MULTIPLE&quot;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Email - Key Rep Changes - New Party NO LONGER USED</fullName>
        <actions>
            <name>Alert_to_Key_Rep_Changes_for_New_Party_to_DS_SalesOps</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <description>When an Account Owner is chnaged to &apos;Unassigned Key-Rep&apos; send an email to ds.SalesOps@adp.com.</description>
        <formula>AND(OwnerId = &apos;0054000000231OB&apos;  )</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>AND(
OR(ISCHANGED( Corporation__c ), ISCHANGED( Group__c ), ISCHANGED( District__c )),
ISBLANK(Corporation__c), ISBLANK(Group__c), ISBLANK(District__c),
Site_Type__r.Corporation_Flag__c = False, Site_Type__r.Group_Flag__c = False, Site_Type__r.District_Flag__c = False, Single_Point__c = False)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(
OR(ISCHANGED( Corporation__c ), ISCHANGED( Group__c ), ISCHANGED( District__c )),
(NOT(ISBLANK(Corporation__c)) || NOT(ISBLANK(Group__c)) || NOT(ISBLANK(District__c))),
Site_Type__r.Corporation_Flag__c = False, Site_Type__r.Group_Flag__c = False, Site_Type__r.District_Flag__c = False, Single_Point__c = True)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
NOT(BEGINS($User.Username,&quot;castiron.integration@adp.com&quot;))&amp;&amp;
(
   ISCHANGED( MDA_NEW__c )||
   ISCHANGED( MDA_Link__c )
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
