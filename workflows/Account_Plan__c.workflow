...
, 1, 0)</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <description>Clear temperature rating only if 90 days have passed without the temp rating field being changed</description>
        <formula>NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c))&amp;&amp;
($RecordType.Name = &quot;AA Account Plan&quot; ||
$RecordType.Name = &quot;PowerSEO Account Plan&quot; ||
$RecordType.Name = &quot;SEO Account Plan&quot;) &amp;&amp;
NOT(ISCHANGED(Temperature__c))&amp;&amp;
TODAY() &gt;= 90+ SDC_Last_Updated__c</formula>
...
OR(ISNEW()&amp;&amp; 
($RecordType.Name = &quot;AA Account Plan&quot; || 
$RecordType.Name = &quot;RDMM Account Plan&quot; || 
$RecordType.Name = &quot;PowerSEO Account Plan&quot; || 
$RecordType.Name = &quot;SEO Account Plan&quot; || 
$RecordType.Name = &quot;PIC Account Plan&quot;) &amp;&amp; 
(NOT(ISBLANK(Current_Health__c))|| 
NOT(ISBLANK(Next_Steps__c))|| 
NOT(ISBLANK(KPI_Changes__c))|| 
NOT(ISBLANK(Enhancement_Requests__c)) 
),($RecordType.Name = &quot;AA Account Plan&quot; || 
$RecordType.Name = &quot;RDMM Account Plan&quot; || 
$RecordType.Name = &quot;PowerSEO Account Plan&quot; || 
$RecordType.Name = &quot;SEO Account Plan&quot; || 
$RecordType.Name = &quot;PIC Account Plan&quot;) &amp;&amp; 
(ISCHANGED(Current_Health__c)|| 
ISCHANGED(Next_Steps__c)|| 
ISCHANGED(KPI_Changes__c)|| 
ISCHANGED(Enhancement_Requests__c) 
))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>OR 
( 
ISCHANGED( Dealer_Hurt__c ) 
,IsCHANGED( Discovery__c ) 
,ISCHANGED( Sales_Process__c ) 
,ISCHANGED( Next_Action_Due__c ) 
,ISCHANGED( Perceived_Reputation__c ) 
,ISCHANGED( Fixed_Operations_Details__c ) 
,ISCHANGED( Location__c ) 
,ISCHANGED( Dealership_Health__c ) 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
$RecordType.Name = &quot;SEO Account Plan&quot;, 
OR 
( 
INCLUDES(Product__c,&apos;ProCare SEO&apos;), 
INCLUDES(Product__c,&apos;Reactive SEO&apos;) 
), 
ISCHANGED( SEO_Maintenance_Only__c ), 
SEO_Maintenance_Only__c = TRUE 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
$RecordType.Name = &quot;SEO Account Plan&quot;, 
SEO_Maintenance_Only__c =TRUE, 
OR( ISPICKVAL(Account_Status__c,&quot;Onboarding&quot;), 
AND(NOT(INCLUDES( Product__c ,&quot;ProCare SEO&quot;)), 
NOT(INCLUDES( Product__c ,&quot;Reactive SEO&quot;))), 
AND(ISCHANGED(Primary__c), Primary__c = TRUE) 
) 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
...
PRIORVALUE(SEO_Flag__c)&lt;&gt;SEO_Flag__c 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>AND ( 
NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)), 
PRIORVALUE(Coaching_Notes__c)&lt;&gt;Coaching_Notes__c 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND (
    NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)),
    PRIORVALUE(Discovery__c)&lt;&gt;Discovery__c
   )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
