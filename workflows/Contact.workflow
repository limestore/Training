...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <ccEmails>xHelpMeIT@CDK.com</ccEmails>
        ...
        <recipients>
            <recipient>vijay.manimaran@cdk.com</recipient>
            <type>user</type>
        </recipients>
        <senderType>CurrentUser</senderType>
    ...
    <rules>
        ...
        <formula>ISCHANGED( Status__c ) &amp;&amp; NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;))</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AccountId  &lt;&gt; &apos;&apos; &amp;&amp; NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;))</formula>
    ...
    <rules>
        ...
        <formula>OR(
AND( ISCHANGED( No_Longer_There__c ), No_Longer_There__c = True), 
AND( ISCHANGED(Status__c ), CASE(Status__c, &quot;Inactive&quot;, &quot;Inactive&quot;, &quot;&quot;) = &quot;Inactive&quot;)) 
&amp;&amp; NOT(BEGINS(Account_Name_Text__c, &quot;CDK Global&quot;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <description>If the No Longer There checkbox was checked and has been unchecked, remove &quot;- LEFT&quot;  from the contact name.</description>
        <formula>OR(
AND(ISCHANGED(No_Longer_There__c), No_Longer_There__c = False), 
AND(ISCHANGED(Status__c), CASE(Status__c, &quot;Active&quot;, &quot;Active&quot;, &quot;&quot;) = &quot;Active&quot;)) 
&amp;&amp; NOT(BEGINS(Account_Name_Text__c, &quot;CDK Global&quot;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
