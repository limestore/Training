...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND(NOW()-DATETIMEVALUE(Roll_Call_Date__c)&gt; 15,ISBLANK(Controller_Review_Date_Time__c),NSA_Attached_By__c&lt;&gt;&apos;Brian Schooley&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
