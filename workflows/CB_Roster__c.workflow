...
NOT(BEGINS($User.Username,&quot;integration_user@cdk.com&quot;)), 
ISPICKVAL( Requisition_Status__c , &quot;Cleared&quot;), 
NOT(ISPICKVAL(PRIORVALUE(Requisition_Status__c),&quot;Cleared&quot;)), 
NOT(ISPICKVAL( Status_Role__c ,&quot;New Hire&quot;)) 
)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
